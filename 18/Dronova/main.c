...
4.	Створити однозв’язний список натуральних чисел введенням нового елементу в кінець списку. 
    Знайти та вивести суму квадратів парних елементів списку. 
    Видалити із списку всі парні елементи та вивести оновлений список. 
    Ви-далити список.
*/
